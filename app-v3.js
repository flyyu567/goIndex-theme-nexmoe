 ...
 */
// 在head 中 加载 必要静态
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/flyyu567/goIndex-theme-nexmoe@1.1.3/css/mdui_v2.min.css">');
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/flyyu567/goIndex-theme-nexmoe@1.1.4/css/nexmoe_v2.min.css">');
document.write('<script src="//cdn.jsdelivr.net/gh/flyyu567/goIndex-theme-nexmoe@1.1.3/js/mdui.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/flyyu567/goIndex-theme-nexmoe@1.1.5/js/flv.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/flyyu567/goIndex-theme-nexmoe@1.1.5/js/DPlayer.min.js"></script>');
// markdown支持
document.write('<script src="//cdn.jsdelivr.net/gh/flyyu567/goIndex-theme-nexmoe@1.1.3/js/markdown-it.min.js"></script>');
...
<header class="nexmoe-nav">
	<div class="navSize">
			...
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="http://wpa.qq.com/msgrd?v=3&uin=1120782828&site=qq&menu=yes" target="_blank">与我联系</a></li>
...
<script src="//cdn.jsdelivr.net/gh/flyyu567/goIndex-theme-nexmoe/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/flyyu567/goIndex-theme-nexmoe/js/ext-language_tools.js"></script>
	`;
  $('#content').html(content);
